...
import 'package:donor_app/organization_portion/accept_donation/clothes_accept.dart';
...
class YesClothes extends StatefulWidget {
  const YesClothes({Key? key}) : super(key: key);

  @override
  _YesClothesState createState() => _YesClothesState();
}

class _YesClothesState extends State<YesClothes> {
  ...
  Future<void> getData() async {
    ...
    QuerySnapshot snapshot = await inst.collection("Clothes Location").get();
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widgets_list['data']![index]["gender"],
                    ...
                    ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ClothesGoogleMapScreen(
                                  gender: widgets_list['data']![index]
                                      ["gender"],
                                  email: widgets_list['data']![index]["email"],
                                  f_name: widgets_list['data']![index]
                                      ["first name"],
                                  age: widgets_list['data']![index]["age"],
