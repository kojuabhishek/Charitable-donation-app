...
class FoodNextLocation extends StatefulWidget {
  ...
  @override
  _FoodNextLocationState createState() => _FoodNextLocationState();
}

class _FoodNextLocationState extends State<FoodNextLocation> {
  var lat, lng;
