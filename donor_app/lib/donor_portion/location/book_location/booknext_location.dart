...
class BookNextLocation extends StatefulWidget {
  ...
  @override
  _BookNextLocationState createState() => _BookNextLocationState();
}

class _BookNextLocationState extends State<BookNextLocation> {
  var lat, lng;
  int x = 0;
