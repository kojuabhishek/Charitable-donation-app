...
class BookCurrentLocation extends StatefulWidget {
  late String? num, language, f_name, s_name, uid, email, category, phNumber;
  int check;
  ...
  @override
  _BookCurrentLocationState createState() => _BookCurrentLocationState();
}

class _BookCurrentLocationState extends State<BookCurrentLocation> {
