...
class ClothesCurrentLocation extends StatefulWidget {
  late String? f_name, s_name, uid, email, gender, age, phNumber;
  int check;

  ClothesCurrentLocation({
    Key? key,
    required this.age,
    required this.uid,
  ...
  @override
  _ClothesCurrentLocationState createState() => _ClothesCurrentLocationState();
}

class _ClothesCurrentLocationState extends State<ClothesCurrentLocation> {
